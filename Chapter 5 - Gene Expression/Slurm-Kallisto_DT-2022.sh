...
#
#SBATCH --job-name=mahe0050_Kallisto
#
##################################################################
...
bash /scratch/user/mahe0050/DE-analysis/bash/kallisto-clstr-clean.sh
...
#cp -r /$BGFS/1_trimmedData/q/ /scratch/user/mahe0050/DE-analysis/1_trimmedData/q/
